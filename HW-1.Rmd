...
px = ggplot(SW, aes(x = long, y = lat, color = state)) + geom_point()
px ## this is just for curiosity's sake, but it looks cool! If only I could figure out how to put a real map under it

q3 = select(SW, `state`, `date`, `iata`)
...
p5 = ggplot(q5, aes(x = carrier, y = percent_in_region, fill = region)) + geom_bar(stat = "identity")
p5 = p5 + scale_fill_brewer(palette = "Spectral")
p5
